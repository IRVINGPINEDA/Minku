...
import { AdminNewTeacher } from "../components/admin/AdminNewTeacher";
import { AdminCourseReport } from "../components/admin/AdminCourseReport";
        ...
        <>
            <BrowserRouter>
                <Routes>
                    ...
                    />
                    <Route path="/admin/courses/:id/reviews" element={
                        <AdminRoute>
                            <Container>
                                <AdminCourseReviews />
                            </Container>
